...
- Evorxa Manager addon: dashboard with setup checklist and monthly economics, settings, plan importer with markup, server reconciliation, activity log, wallet and drift alerts, hourly stock sync.
